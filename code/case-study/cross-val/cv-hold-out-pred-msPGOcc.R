# cv-hold-out-pred-msPGOcc.R: this script runs a non-spatial multi-species occupancy model
...
#                             spatial autocorrelation. This script uses only 25% of the
#                             data for use in hold-out validation. 
...
# Save results ------------------------------------------------------------
save(out, file = paste("results/bbs-hold-out-msPGOcc-", chain, "-chain-", 
		       Sys.Date(), ".R", sep = ''))
