# cv-main-sfMsPGOcc.R: this script runs a spatially-explicit joint species distribution model
...
#                      This script only uses 75% of the data locations for use in 
#                      cross-validation. 
...
save(out, pred.indx, file = paste("results/bbs-cv-sfMsPGOcc-", chain, "-chain-", 
		                  Sys.Date(), ".R", sep = ''))
